...
func MenuLivresSorts(p *character.Personnage) {
	...
	fmt.Println("1. Livre de sort: Boule de Feu (50 PO) (Niv 1+)")
	fmt.Println("2. Livre de sort: Soin Magique (250 PO) (Niv 2+)")
	...
	switch choix {
	case "1":
		AcheterObjet(p, "Livre de sort: Boule de Feu", 50, 1)
	case "2":
		AcheterObjet(p, "Livre de sort: Soin Magique", 250, 2)
	case "3":
